...
import {LeverageModuleHarness} from "../harness/LeverageModuleHarness.sol";
...
abstract contract Setup is Test {
    ...
    LeverageModuleHarness internal leverageModProxy;
    ...
    function setUp() public virtual {
        ...
        WETH = new MockERC20("WETH Mock", "WETH");
        ...
        leverageModImplementation = address(new LeverageModuleHarness());
        ...
        leverageModProxy = LeverageModuleHarness(
        ...
        vaultProxy.initialize({
            _collateral: MockERC20(address(WETH)),
        ...
        pointsModProxy.initialize({
            ...
            _mintRateMaxAccumulated: 100_000e18,
            _mintRateDecayTime: 1 days
        });
