...
/// @dev Fetched the file from: https://github.com/ind-igo/forge-safe/blob/4ce820bad668846207f34b6f439021ad151f0a1e/src/BatchScript.sol#L14
// ⭐️ SCRIPT
abstract contract BatchScript is Script, DelegatePrank {
    ...
    string private constant VERSION = "1.3.0 | 1.4.1";
    ...
    function _initialize() private {
        ...
        if (chainId == 84532) {
            ...
            revert(string.concat("Unsupported chain id ", chainIdStr));
        }
    ...
    function _sendBatch(address safe_, Batch memory batch_) internal {
        ...
        string memory payload = placeholder.serialize("sender", msgSender);
